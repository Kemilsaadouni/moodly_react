...
const MoodGraph = ({ dailyAverages }) => {
  ...
  const options = {
    maintainAspectRatio: true,  // Désactiver l'aspect ratio pour permettre au graphique de s'étendre
    layout: {
      padding: {
  ...
  return (
    <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100%'}}>
      <div style={{ width: '90%', maxWidth: '900px', padding: '30px', backgroundColor: '#fff', borderRadius: '15px', boxShadow: '0 4px 8px rgba(0, 0, 0, 0.1)'}}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', width: '300px', margin: '5px auto' }}>
          <h5>En colère</h5>
          <h5>Neutre</h5>
          <h5>Très heureux</h5>
        </div>
